...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__files_routes__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__files_store__ = __webpack_require__(65);
 ...
 */
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('pagination-links', __webpack_require__(67));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('btn-load-modal-del', __webpack_require__(70));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('mstro-3-columnas', __webpack_require__(73));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('delete-record', __webpack_require__(76));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('edit-record', __webpack_require__(79));
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('new-record', __webpack_require__(82));

var VueApp = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  el: '#VueApp',
  router: __WEBPACK_IMPORTED_MODULE_1__files_routes__["a" /* default */],
  store: __WEBPACK_IMPORTED_MODULE_2__files_store__["a" /* store */]
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
   routes: [{ component: __webpack_require__(38), name: 'DashBoard', path: '/' }, { component: __webpack_require__(41), name: 'cargos', path: '/cargos' }, { component: __webpack_require__(45), name: 'ejemplo', path: '/ejemplo' }, { component: __webpack_require__(48), name: 'pedidos', path: '/pedidos' }],
...
Component.options.__file = "resources/js/app/inicio/DashBoard.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-42e766d6", Component.options)
  } else {
    hotAPI.reload("data-v-42e766d6", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-42e766d6", module.exports)
  }
}
...
Component.options.__file = "resources/js/app/maestros/Cargos.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1ef8bca6", Component.options)
  } else {
    hotAPI.reload("data-v-1ef8bca6", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mixins_FormValidation__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mixins_FormValidation___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__mixins_FormValidation__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__files_messages_js__ = __webpack_require__(43);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mixins: [__WEBPACK_IMPORTED_MODULE_0__mixins_FormValidation___default.a],
    methods: {
        Listar: function Listar() {
            var _this = this;

            var Me = this;
            axios.get('/cargos?page=' + (this.$route.query.page || 1)).then(function (response) {
                Me.DatosTabla = response.data.data;
                Me.Pagination = response.data;
                delete Me.Pagination.data;
                _this.ErrorsController = {};
            }).catch(this.ErrorOnFail);
        },
        CierraModalEdit: function CierraModalEdit() {
            this.Listar();
        },
        ShowModalBorrar: function ShowModalBorrar(Registro) {
            this.DatosModal = Registro;
        },
        ShowModalEdit: function ShowModalEdit(Registro) {
            this.DatosModal = Registro;
        },
        GrabarRegDataBase: function GrabarRegDataBase(NomCargo) {
            var _this2 = this;
            ...
            axios.post('/cargos', { 'nom_cargo': NomCargo
                ...
                _this2.Listar();
                toastr.success(__WEBPACK_IMPORTED_MODULE_1__files_messages_js__["a" /* MSG */].DbNewOk);
            }).catch(this.ErrorOnFail);
        },
        ActualizarRegDataBase: function ActualizarRegDataBase(Registro) {
            var Me = this;
            ...
            axios.put(URL, { 'nom_cargo': Registro.nom_cargo, 'id_cargo': Registro.id_cargo, 'inactivo': Registro.inactivo
                ...
                toastr.success(__WEBPACK_IMPORTED_MODULE_1__files_messages_js__["a" /* MSG */].DbUpdOk);
            }).catch(this.ErrorOnFail);
        },
        BorraRegDataBase: function BorraRegDataBase(Registro) {
            var Me = this;
            var url = this.UrlBase + Registro.id_reg;
            axios.delete(url).then(function (response) {
                Me.Listar();
                toastr.success(__WEBPACK_IMPORTED_MODULE_1__files_messages_js__["a" /* MSG */].DbDelOk);
            }).catch(function (error) {
                toastr.error(__WEBPACK_IMPORTED_MODULE_1__files_messages_js__["a" /* MSG */].DbIntegridad);
            });
        }
    } // Methods
...
var MSG = {
    Ped_Prd_Doble: Ped_Prd_Doble, Sel_Cliente: Sel_Cliente, Save_Reg_Ok: Save_Reg_Ok, Det_Null_Tit: Det_Null_Tit, Det_Null: Det_Null,
    Reg_Doble_Tit: Reg_Doble_Tit, DbIntegridad: DbIntegridad, DbDelOk: DbDelOk, DbUpdOk: DbUpdOk, DbNewOk: DbNewOk,
    Ped_Prd_Add: Ped_Prd_Add
};
  ...
  return _c(
    ...
    [
      _c(
        "mstro-3-columnas",
        {
          attrs: { DatosTabla: _vm.DatosTabla, Pagination: _vm.Pagination },
          on: {
            BtnTablaBorrarReg: _vm.ShowModalBorrar,
            BtnTablaEditReg: _vm.ShowModalEdit
          }
        },
        [
          _c("template", { slot: "CardTitle" }, [_vm._v("Cargos")]),
          _vm._v(" "),
          _c("template", { slot: "BtnAddcaption" }, [
            _vm._v("Agregar Nuevo Cargo")
          ]),
          _vm._v(" "),
          _c("template", { slot: "Column1Caption" }, [
            _vm._v("Nombre/Descripción")
          ]),
          _vm._v(" "),
          _c("template", { slot: "Column2Caption" }, [_vm._v("Estado")]),
          _vm._v(" "),
          _c("template", { slot: "Column3Caption" }, [
      ...
      _c(
        "delete-record",
        {
          attrs: { Registro: _vm.DatosModal },
          on: { BorraRegDataBase: _vm.BorraRegDataBase }
        },
        [
          _c("template", { slot: "ModalTitle" }, [
            _vm._v(
              "Confirma que desea borrar el cargo que se muestra en pantalla ?"
            )
          ])
        ],
        2
      ...
      _c(
        ...
        {
          attrs: {
            Registro: _vm.DatosModal,
            ErrorsController: _vm.ErrorsController
          },
          on: {
            ActualizarRegDataBase: _vm.ActualizarRegDataBase,
            CierraModal: _vm.CierraModalEdit
          }
        },
        [
          _c("template", { slot: "ModalTitle" }, [
            _vm._v("Modificación del registro")
          ])
        ],
        2
      ),
      ...
      _c(
        "new-record",
        {
          attrs: { ErrorsController: _vm.ErrorsController },
          on: {
            GrabarRegDataBase: _vm.GrabarRegDataBase,
            CierraModal: _vm.CierraModalEdit
          }
        },
        [_c("template", { slot: "ModalTitle" }, [_vm._v("Nuevo registro")])],
        2
      )
    ],
    1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1ef8bca6", module.exports)
  }
}
...
Component.options.__file = "resources/js/app/inicio/Ejemplo.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7754f4a8", Component.options)
  } else {
    hotAPI.reload("data-v-7754f4a8", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
    ...
    return _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "row justify-content-center" }, [
        _c("div", { staticClass: "col-md-8" }, [
          _c("div", { staticClass: "card card-default" }, [
            _c("div", { staticClass: "card-header" }, [
              _vm._v("otro ejmplo de compoenente")
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "card-body" }, [
              _vm._v(
                "\n                    Yo soy un ejemplo de componente nuevo...\n                "
              )
            ])
          ])
        ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7754f4a8", module.exports)
  }
}
...
Component.options.__file = "resources/js/app/comercial/Pedidos.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-61d489a2", Component.options)
  } else {
    hotAPI.reload("data-v-61d489a2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_clientes_productos_comprados__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_clientes_productos_comprados___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_clientes_productos_comprados__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_modals_TercerosClientesBuscar__ = __webpack_require__(85);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_modals_TercerosClientesBuscar___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_modals_TercerosClientesBuscar__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_datetime__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_datetime_dist_vue_datetime_css__ = __webpack_require__(59);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        datetime: __WEBPACK_IMPORTED_MODULE_2_vue_datetime__["Datetime"], ProductosComprados: __WEBPACK_IMPORTED_MODULE_0__components_clientes_productos_comprados___default.a, ClientesBuscar: __WEBPACK_IMPORTED_MODULE_1__components_modals_TercerosClientesBuscar___default.a
    }
});
...
Component.options.__file = "resources/js/components/clientes/productos_comprados.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4e83955a", Component.options)
  } else {
    hotAPI.reload("data-v-4e83955a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
              ...
              _c("table", { staticClass: "table table-bordered" }, [
                _c("thead", [
                  _c("tr", [
                    ...
                    _c("th", [_vm._v(" Financ.")]),
                    _vm._v(" "),
                    _c("th", [_vm._v(" Mayor Vr.")]),
                    _vm._v(" "),
                    _c("th", [_vm._v(" Dscto")]),
                    _vm._v(" "),
                    _c("th", [_vm._v(" Vr.Unit.")]),
                    _vm._v(" "),
                    _c("th")
                  ])
                ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4e83955a", module.exports)
  }
}
...
function weekStart () {
  ...
  try {
    weekstart = __webpack_require__(55);
  } catch (e) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_js__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__langRegionMap_js__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__regionDayMap_js__ = __webpack_require__(58);
          ...
          _c("div", { staticClass: "card-body" }, [
            _c("div", { staticClass: "row" }, [
              ...
              _c(
                ...
                [
                  _c("label", [_vm._v("Fecha Despacho")]),
                  _vm._v(" "),
                  _c("datetime", {
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      {
        ...
        staticStyle: { "background-color": "#dbdce0" }
      },
      [
        _c("h4", [
          _c("i", { staticClass: "la la-bars" }),
          _vm._v("  Registro de Pedidos")
        ])
      ]
    )
  },
      ...
      _c("div", { staticClass: "form-group form-inline" }, [
        _c(
          "button",
          {
            ...
            attrs: {
              "data-target": "#ModalClientesBuscar",
              "data-toggle": "modal"
            }
          },
        ...
        _vm._v("\n                    "),
        _c("input", {
          staticClass: "form-control border-primary campo-form",
          attrs: { placeholder: "Nombre del cliente", disabled: "disabled" }
        })
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "col-md-3" }, [
      ...
      _c("div", { staticClass: "form-group" }, [
        _c("input", {
          staticClass: "form-control border-primary campo-form",
          attrs: { placeholder: "Sucursal", disabled: "disabled" }
        })
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "col-md-3" }, [
      ...
      _c("input", {
        staticClass: "form-control border-primary campo-form",
        attrs: { placeholder: "Vendedor", disabled: "disabled" }
      })
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-sm-3" }, [
        _c("label", [_vm._v("Orden Compra")]),
        _vm._v(" "),
        _c("input", {
          staticClass: "form-control border-primary campo-form",
          attrs: { placeholder: "Número orden compra" }
        })
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "col-sm-9" }, [
        _c("label", [_vm._v("Observaciones del pedido")]),
        _vm._v(" "),
        _c("input", {
          staticClass: "form-control border-primary campo-form",
          attrs: { placeholder: "Observaciones del pedido" }
        })
      ])
    ])
  },
  function() {
    ...
    return _c(
      "ul",
      { staticClass: "nav nav-tabs nav-linetriangle no-hover-bg" },
      [
  ...
  function() {
    ...
    return _c(
      "div",
      {
        ...
        attrs: { id: "tab42", "aria-labelledby": "base-tab42" }
      },
      [_c("p", [_vm._v("Tab 2.")])]
    )
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-61d489a2", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/user_interface/PaginationLinks.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3f4cea60", Component.options)
  } else {
    hotAPI.reload("data-v-3f4cea60", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3f4cea60", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/user_interface/btn-load-modal-delreg.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b3c298c0", Component.options)
  } else {
    hotAPI.reload("data-v-b3c298c0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
    ...
    _c(
      "button",
      {
        ...
        attrs: {
          ...
          "data-toggle": "modal",
          "data-backdrop": "false",
          "data-target": "#backdrop1"
        }
      },
      [_vm._t("BtnCaption", [_vm._v(" Cargar Modal ")])],
      2
    )
  ])
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-b3c298c0", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/views/MstroDescripActivoEditDel.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-857c9050", Component.options)
  } else {
    hotAPI.reload("data-v-857c9050", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        BtnTablaEditReg: function BtnTablaEditReg(Registro) {
            this.$emit('BtnTablaEditReg', Registro);
        },
        BtnTablaBorrarReg: function BtnTablaBorrarReg(Registro) {
  ...
  return _c("div", { staticClass: "row justify-content-center" }, [
    _c("div", { staticClass: "col-lg-8 col-md-12" }, [
      _c("div", { staticClass: "card border-info" }, [
            ...
            _c("div", { staticClass: "col-md-8 d-flex align-items-center" }, [
              _c("h4", [
                ...
                _c(
                  "span",
                  {
                    staticClass: "menu-title card-title text-dark",
                    attrs: { "data-i18n": "nav.dash.main" }
                  },
                  [
                    _vm._v(" "),
                    _c("strong", [_vm._t("CardTitle", [_vm._v(" Título ")])], 2)
                  ]
                )
              ])
            ]),
            ...
            _c("div", { staticClass: "col-lg-4" }, [
              _c(
                "button",
                {
                  staticClass: "btn btn-success  btn-sm float-md-right",
                  attrs: {
                    "data-target": "#ModalNewReg",
                    "data-toggle": "modal"
                  }
                },
                [
                  _c("i", { staticClass: "ft-folder" }),
                  _vm._v(" "),
                  _vm._t("BtnAddcaption", [
                    _vm._v(" Agregar nuevo cargo        ")
                  ])
                ],
                2
        ...
        _c(
          "div",
          { staticClass: "card-content", attrs: { "aria-expanded": "true" } },
          [
            _c("div", { staticClass: "card-body" }, [
              _c("div", { staticClass: "card-text" }, [
                _c(
                  "div",
                  { staticClass: "table-responsive table-sm" },
                  [
                    _c(
                      "table",
                      {
                        ...
                        _c("thead", [
                          _c("tr", [
                            ...
                            _c(
                              "th",
                              [
                                _vm._t("Column2Caption", [_vm._v(" Activo ? ")])
                              ],
                              2
                            ),
                            _vm._v(" "),
                        ...
                        _c(
                          ...
                          _vm._l(_vm.DatosTabla, function(Registro) {
                            return _c("tr", [
                              _c("td", {
                                domProps: {
                                  textContent: _vm._s(Registro.nom_reg)
                                }
                              }),
                              _vm._v(" "),
                              ...
                              _c(
                                ...
                                [
                                  _c(
                                    ...
                                    {
                                      staticClass:
                                        "btn btn-icon btn-info  btn-xs",
                                      attrs: {
                                        type: "button",
                                        "data-target": "#ModalEditReg",
                                        "data-toggle": "modal",
                                        "data-original-title":
                                          "Modificar registro"
                                      },
                                  ...
                                  _c(
                                    ...
                                    {
                                      staticClass:
                                        "btn btn-icon btn-danger  btn-xs",
                                      attrs: {
                                        type: "button",
                                        "data-target": "#ModalBorraReg",
                                        "data-toggle": "modal",
                                        "data-original-title":
                                          "Eliminar registro"
                                      },
                                      on: {
                                        click: function($event) {
                                          _vm.BtnTablaBorrarReg(Registro)
                                        }
                                      }
                                    },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-857c9050", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/modals/DeleteRecord.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9165e4ec", Component.options)
  } else {
    hotAPI.reload("data-v-9165e4ec", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("div", { staticClass: "modal-content border-danger" }, [
            _c("div", { staticClass: "modal-header bg-danger " }, [
              _c(
                "h5",
                {
                  staticClass: "modal-title text-white",
                  attrs: { id: "myModalLabel4" }
                },
                [_vm._t("ModalTitle", [_vm._v("Basic Modal")])],
                2
              ),
              _vm._v(" "),
              _vm._m(0)
            ...
            _c("div", { staticClass: "modal-body" }, [
              _c("p", [
                _c("strong", [_vm._v(_vm._s(_vm.Registro.nom_reg) + " ?  ")])
              ])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "modal-footer" }, [
              _c(
                "button",
                {
                  staticClass: "btn grey btn-secondary btn-sm",
              ...
              _c(
                "button",
                {
                  ...
                  on: {
                    click: function($event) {
                      _vm.BorraRegDataBase(_vm.Registro)
                    }
                  }
                },
                [_vm._v("Borrar")]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-9165e4ec", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/modals/EditRecord.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3e5118a9", Component.options)
  } else {
    hotAPI.reload("data-v-3e5118a9", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        QuitarClaseError: function QuitarClaseError(Control) {
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("div", { staticClass: "modal-content border-info" }, [
            ...
            _c("div", { staticClass: "modal-body" }, [
              ...
              _c(
                "form",
                {
                  staticClass: "form-horizontal form-simple",
                  attrs: {
                    novalidate: "",
                    method: "POST",
                  ...
                  on: {
                    keydown: function($event) {
                      _vm.ErrorsClear($event.target.name)
                    }
                  }
                },
                [
                  ...
                  _c(
                    "fieldset",
                    {
                      ...
                      class: { error: _vm.ErrorHas("nom_cargo") }
                    },
                    [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.Registro.nom_cargo,
                            expression: "Registro.nom_cargo"
                          }
                        ],
                        staticClass: "form-control form-control-lg input-lg",
                        attrs: { type: "text" },
                        domProps: { value: _vm.Registro.nom_cargo },
                        on: {
                      ...
                      _vm._v(" "),
                      _vm.ErrorHas("nom_cargo")
                        ? _c("div", { staticClass: "invalid-data" }, [
                            _c("i", { staticClass: "ft-x-square" }),
                            _vm._v(" "),
                            _c("span", {
                              staticClass: "invalid-data",
                              domProps: {
                                textContent: _vm._s(_vm.ErrorGet("nom_cargo"))
                              }
                            })
                          ])
                        : _vm._e()
                  ...
                  _c("fieldset", [
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.Registro.inactivo,
                          expression: "Registro.inactivo"
                        }
                      ],
                      attrs: { type: "checkbox", id: "checkbox" },
                      domProps: {
                        checked: _vm.Registro.inactivo,
                        checked: Array.isArray(_vm.Registro.inactivo)
                          ? _vm._i(_vm.Registro.inactivo, null) > -1
                          : _vm.Registro.inactivo
                      },
                      on: {
                        change: function($event) {
                          var $$a = _vm.Registro.inactivo,
                            $$el = $event.target,
                          ...
                          if (Array.isArray($$a)) {
                            ...
                            _vm.$set(_vm.Registro, "inactivo", $$c)
                          }
                        }
                      }
                    }),
                    ...
                    !_vm.Registro.inactivo
                      ? _c("label", { attrs: { for: "checkbox" } }, [
                          _vm._v(" Registro Activo")
                        ])
                      : _c("label", { attrs: { for: "checkbox" } }, [
                          _vm._v(" Registro Inactivo")
                        ])
                  ])
                ]
              )
            ...
            _c("div", { staticClass: "modal-footer" }, [
              ...
              _c(
                "button",
                {
                  ...
                  on: {
                    click: function($event) {
                      _vm.ActualizarRegDataBase(_vm.Registro)
                    }
                  }
                },
                [_vm._v("Grabar")]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3e5118a9", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/modals/NewRecord.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2f96465a", Component.options)
  } else {
    hotAPI.reload("data-v-2f96465a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        GrabarRegDataBase: function GrabarRegDataBase(Registro) {
        ...
        ErrorsClearLocal: function ErrorsClearLocal() {
            ...
            _c("div", { staticClass: "modal-body" }, [
              ...
              _c(
                "form",
                {
                  ...
                  on: {
                    keydown: function($event) {
                      _vm.ErrorsClearLocal($event.target.name)
                    }
                  }
                },
                [
                  _c(
                    ...
                    {
                      staticClass: "form-group position-relative",
                      class: { error: _vm.ErrorValidacion }
                    },
                    [
                      _c("div", { class: { error: _vm.ErrorValidacion } }, [
                        _vm._v(" Descripción del cargo ")
                      ]),
                      _vm._v(" "),
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.Registro_Nom,
                            expression: "Registro_Nom"
                          }
                        ],
                        staticClass: "form-control form-control-lg input-lg",
                        attrs: { type: "text" },
                        domProps: { value: _vm.Registro_Nom },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.Registro_Nom = $event.target.value
                          }
                        }
                      }),
                      _vm._v(" "),
                      _vm.ErrorValidacion
                        ? _c("div", { staticClass: "invalid-data" }, [
                            _c("i", { staticClass: "ft-x-square" }),
                            _vm._v(" "),
                            _c("span", { staticClass: "invalid-data" }, [
                              _vm._v(" Cargo o perfil es un dato obligatorio. ")
                            ])
                          ])
                        : _vm._e()
                    ]
            ...
            _c("div", { staticClass: "modal-footer" }, [
              ...
              _c(
                "button",
                {
                  ...
                  on: {
                    click: function($event) {
                      _vm.GrabarRegDataBase(_vm.Registro_Nom)
                    }
                  }
                },
                [_vm._v("Grabar")]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2f96465a", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/modals/TercerosClientesBuscar.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-005127a4", Component.options)
  } else {
    hotAPI.reload("data-v-005127a4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "modal-dialog", attrs: { role: "document" } }, [
        _c("div", { staticClass: "modal-content border-success" }, [
          _c("div", { staticClass: "modal-header bg-info " }, [
            _c(
              "h5",
              {
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "modal-body" }, [
      _c("p", [_vm._v(" Muestro resultados")])
    ])
  }
]
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-005127a4", module.exports)
  }
}
