                      ...
                      <form class="form-horizontal form-simple" action="{{ route('login') }}" novalidate method="POST">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6 col-12 text-center text-md-right">
                            <a href="{{ route( 'password.reset.show.form' )}}"
                            class="card-link">No tengo contraseña u olvidé la que tenía. Quiero asignar una para ingreso al sistema.
                           </a></div>
                        </div>
